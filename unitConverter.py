...
while i == 0:
    ...
    print("5. Type '5' or 'quit' to quit")
    ...
    elif choi == "quit" or choi == 5:
        print("Alright, I'll quit")
        break

    else:
        print(" Error. How hard is it to type an ineger between 1 and 4 you silly piece of Broccoli?")
